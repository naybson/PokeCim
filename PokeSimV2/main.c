...
#include <stdlib.h>
#include <string.h>
#include <windows.h>   // Windows console and system functions
...
float type_chart[POKITYPE_COUNT][POKITYPE_COUNT];
...
int main()
{
    ...
    context.moveList = load_move_list_dynamic("moves_list.txt", &context.totalMoves);
